...
public class FacturasAboutBox extends javax.swing.JDialog {

    public FacturasAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(facturasapp.FacturasApp.class).getContext().getResourceMap(FacturasAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(facturasapp.FacturasApp.class).getContext().getActionMap(FacturasAboutBox.class, this);
    ...
    private void appHomepageLabelMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_appHomepageLabelMouseExited
        appHomepageLabel.setForeground(Color.black);
        appHomepageLabel.setCursor(new Cursor(Cursor.DEFAULT_CURSOR));
