...
//    File testFile = new File("C:\\Temp\\blah.txt");
    File inputFile = new File("C:\\OutputTask.xml");
    File outputFile = new File("C:\\OutputTask_reloaded.xml");

    File out = new File("C:\\xml.txt");

    String inputString=getContents(inputFile);
    System.out.println("Original file contents: " + inputString);
    //setContents(outputFile, "The content of this file has been overwritten...");
    setContents(outputFile, inputString, false);
    System.out.println("New file contents: " + getContents(outputFile));

    setContents(out, "prueba", false);
